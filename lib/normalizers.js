...
export function applyAnthropicNormalization(payload, requestBody) {
  ...
  if (normalizedToolCalls.length === 0) {
    ...
    // NOT: Proje-spesifik exploration fallback'lari (find ., /workspace, /init vb.)
    // kaldirildi; proxy artik sadece upstream'in gercek uretimini temizler, kendi
    // kafasindan komut enjekte etmez. Boylece her OS ve her proje dizininde calisir.
    if (content.length === 0) {
